...
if user_input := st.chat_input("메시지 입력..."):
    ...
    with st.chat_message("assistant"):
        # 여기서 중요한 것: 매번 캐릭터 설명을 보내지 않음! 
        # 이미 설정된 chat 세션이 알아서 대화 흐름을 기억함
